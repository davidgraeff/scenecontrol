...
class ActorPulseSink : public AbstractServiceProvider
{
    Q_OBJECT
    Q_PROPERTY(QString sinkid READ sinkid WRITE setSinkid)
    Q_CLASSINFO("sinkid_model", "PulseAudioSinkModel")
...
public:
    ...
    ActorPulseSink(QObject* parent = 0);
    ...
    void setSinkid( const QString& sinkid ) {
        m_sinkid = sinkid;
    }
