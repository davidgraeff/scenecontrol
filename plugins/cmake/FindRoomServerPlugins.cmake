...
macro(install_client_lib)
	INSTALL(TARGETS ${PROJECT_NAME}_client RUNTIME DESTINATION ${ROOM_SYSTEM_CLIENTPLUGINS} LIBRARY DESTINATION ${ROOM_SYSTEM_CLIENTPLUGINS} CONFIGURATIONS Debug Release RelWithDebInfo)
endmacro()

macro(install_server_lib)
	INSTALL(TARGETS ${PROJECT_NAME}_server RUNTIME DESTINATION ${ROOM_SYSTEM_SERVERPLUGINS} LIBRARY DESTINATION ${ROOM_SYSTEM_SERVERPLUGINS} CONFIGURATIONS Debug Release RelWithDebInfo)
endmacro()
